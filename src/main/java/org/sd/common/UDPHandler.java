...
public class UDPHandler {
    ...
    public String Receive()  {
        // 1 BYTE DE OPERAÇÃO | 20 BYTES DE CHAVE | 1400 BYTES DE VALOR | 4 BYTES NUMERO DA PORTA DE CALLBACK ASSYNC
        // TOTALIZANDO 1426 BYTES (CADA '|' É UM CHAR E OCUPA UM BYTE)
        // COLOCAR O TOTAL DE 1500 PARA TRATAR IMPREVISTOS
